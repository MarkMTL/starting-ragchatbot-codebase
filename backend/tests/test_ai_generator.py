...
class TestGenerateResponse:
    def test_no_tools_single_plain_call(self, generator, mock_anthropic_response_factory):
        generator.client.messages.create.return_value = mock_anthropic_response_factory.text("hi")
    ...
    def test_rounds_exhausted_forces_tools_stripped_final(self, generator, mock_anthropic_response_factory):
        tool_mgr = MagicMock()
    ...
    def test_tool_error_breaks_to_final(self, generator, mock_anthropic_response_factory):
        tool_mgr = MagicMock()
    ...
    def test_history_injected_into_system(self, generator, mock_anthropic_response_factory):
        generator.client.messages.create.return_value = mock_anthropic_response_factory.text("ok")
